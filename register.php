                                ...
                                <div class="card-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control-file" id="foto" name="foto" type="file" placeholder="Masukan anda lengkap anda" accept=".png, .jpg, .jpeg"/>
                                        </div>
                                        <div class="form-group">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Mountainesia 2022</div>
                    </div>
                </div>
            </footer>
        </div>
